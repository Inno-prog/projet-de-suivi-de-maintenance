        ...
        try {
            ...
            for (java.util.Map.Entry<String, Integer> entry : itemQuantities.entrySet()) {
                ...
                try {
                    ...
                    Optional<com.dgsi.maintenance.entity.Item> itemOpt = itemRepository.findById(itemId);
                    if (itemOpt.isPresent()) {
                        ...
                        invalidItems.add(itemIdStr + " (item non trouvé)");
                    }
                } catch (NumberFormatException e) {
                    invalidItems.add(itemIdStr + " (ID invalide)");
                }
            }
