-- Script pour supprimer toutes les prestations et réinitialiser les quantités des items à zéro
-- Ce script est sécurisé et ne touche pas aux contrats

-- Commencer une transaction pour s'assurer que tout est exécuté atomiquement
BEGIN;

-- =====================================================
-- ÉTAPE 1: Supprimer toutes les liaisons prestation-item
-- =====================================================
DELETE FROM prestation_item;

-- =====================================================
-- ÉTAPE 2: Supprimer toutes les liaisons fiche-prestation-item
-- =====================================================
...
-- =====================================================
-- ÉTAPE 5: Réinitialiser les quantités utilisées de tous les items à zéro
-- =====================================================
UPDATE items 
...
SELECT 
    ...
    COALESCE(SUM(quantite_utilisee), 0) as total_quantite_utilisee,
    COALESCE(SUM(quantite_utilisee_trimestre), 0) as total_quantite_trimestre
FROM items;
